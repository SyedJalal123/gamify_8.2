					...
					<div class="sign__content">
						...
						<form method="POST" action="{{ route('register') }}" class="sign__form">
							...
							<div class="sign__group">
								<input class="sign__input" placeholder="Name" id="name" type="text" name="name" :value="old('name')" required autofocus autocomplete="name">
							...
							<div class="sign__group">
								<input type="password" id="password" name="password" class="sign__input" placeholder="Password" required autocomplete="new-password">
                                <x-input-error :messages="$errors->get('password')" class="mt-2" style="color:red;" />
							</div>

                            <div class="sign__group">
								<input type="password" id="password_confirmation" name="password_confirmation" class="sign__input" placeholder="Confirm Password" required autocomplete="new-password">
