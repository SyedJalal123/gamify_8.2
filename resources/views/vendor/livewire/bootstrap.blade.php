            ...
            @else
                <li class="page-item">
                    <button type="button"
                            ...
                            wire:loading.attr="disabled">First</button>
                </li>
            @endif
            ...
            @else
                <li class="page-item">
                    <button type="button"
                            ...
                            x-on:click="{{ $scrollIntoViewJsSnippet }}"
                            wire:loading.attr="disabled"><i class="bi bi-chevron-left"></i></button>
                </li>
            @endif
            ...
            @if ($paginator->hasMorePages())
                <li class="page-item">
                    <button type="button"
                            ...
                            x-on:click="{{ $scrollIntoViewJsSnippet }}"
                            wire:loading.attr="disabled"><i class="bi bi-chevron-right"></i></button>
                </li>
            @else
                <li class="page-item disabled" aria-disabled="true">
            ...
            @if ($paginator->hasMorePages())
                <li class="page-item">
                    <button type="button"
                            ...
                            x-on:click="{{ $scrollIntoViewJsSnippet }}"
                            wire:loading.attr="disabled">Last</button>
                </li>
            @else
                <li class="page-item disabled" aria-disabled="true">
