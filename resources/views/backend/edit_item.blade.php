            ...
            document.addEventListener("click", function (e) {
                if (e.target && e.target.id === "add-attribute-btn") {
                    ...
                    inputs.forEach(input => {
                        ...
                        if (input.id.includes("attribute_type_input_")) {
                            input.name = `attribute_type_${serviceNum}_${nextAttrIndex}[]`;
                            input.id = `attribute_type_input_${serviceNum}_${nextAttrIndex}`;
                            input.value = 'text';
                        }
                        if (input.id.includes("attribute_type_select_")) {
                            input.name = `attribute_type_${serviceNum}_${nextAttrIndex}[]`;
                            input.id = `attribute_type_select_${serviceNum}_${nextAttrIndex}`;
                            input.value = 'select';
                        }
                    });
