        ...
        <div class="card-header border-0 pt-6">
            ...
            <div class="card-title">
                ...
                <div class="d-flex align-items-center position-relative my-1">
                    ...
                    <!--end::Svg Icon-->
                    <input type="text" id="datatable-search" class="form-control form-control-solid w-250px ps-14" placeholder="Search category" />
                </div>
                <!--end::Search-->
            </div>
            <!--begin::Card title-->
            ...
            <div class="card-toolbar">
                ...
                <div class="d-flex justify-content-end" data-kt-user-table-toolbar="base">
                    ...
                    <!--end::Svg Icon-->Add Cateogory</button>
                    <!--end::Add user-->
                </div>
                <!--end::Toolbar-->
...
@section('js')
    ...
    <script>
        ...
        var gamesTable = $('#gamesTable').DataTable({
            ...
            lengthChange: false,
            ajax: {
                url: '{{ route("admin.articles.categories") }}',
            },
            columns:[
                { 
                    data: 'name', name: 'name', className: 'desktop-only',
        ...
        function edit_category_modal_values(name, id) {
    ...
    <div class="modal fade" id="kt_modal_edit_category" tabindex="-1" aria-hidden="true">
        ...
        <div class="modal-dialog modal-dialog-centered mw-650px">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                    <!--begin::Form-->
                    <form id="kt_modal_edit_category_form" class="form" action="{{ url('admin/edit_article_category') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <!--begin::Scroll-->
                        <div class="d-flex flex-column scroll-y me-n7 pe-7" id="kt_modal_edit_category_scroll" data-kt-scroll="true" data-kt-scroll-activate="{default: false, lg: true}" data-kt-scroll-max-height="auto" data-kt-scroll-dependencies="#kt_modal_add_user_header" data-kt-scroll-wrappers="#kt_modal_add_user_scroll" data-kt-scroll-offset="300px">
                            ...
                            <div class="fv-row mb-7">
                                ...
                                <!--end::Label-->
                                <!--begin::Input-->
                                <input type="text" name="name" class="form-control form-control-solid mb-3 mb-lg-0" id="edit-category-name" placeholder="Name" required/>
                                <input type="hidden" name="category_id" class="form-control form-control-solid mb-3 mb-lg-0" id="edit-category-id" />
                                <!--end::Input-->
                            </div>
                            <!--end::Input group-->
                        </div>
                            ...
                            <button type="submit" class="btn btn-primary edit-submit-button"
                              onclick="
                                    ...
                                    if (form.checkValidity()) {
                                        document.getElementsByClassName('edit-category-wait')[0].classList.remove('d-none');
                                        document.getElementsByClassName('edit-category-wait')[0].classList.add('d-block');
                                        document.getElementsByClassName('edit-category-submit')[0].classList.add('d-none');
                                    ...
                                    ">
                                <span class="indicator-label edit-category-submit">Submit</span>
                                <span class="edit-category-wait d-none">Please wait...  
                                <span class="spinner-border spinner-border-sm align-middle ms-2"></span></span>
                            </button>
                        </div>
                        <!--end::Actions-->
