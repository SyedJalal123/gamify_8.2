...
@section('content')
    ...
    <section class="section section--bg section--first" data-bg="GoGame – Digital marketplace HTML Template Preview - ThemeForest_files/img/bg.jpg" style="background: url(&quot;GoGame – Digital marketplace HTML Template Preview - ThemeForest_files/img/bg.jpg&quot;) center top 140px / auto 500px no-repeat;">
        ...
        <div class="owl-carousel section__carousel section__carousel--big owl-loaded" id="carousel0">
            ...
            <!-- end big card -->
        <div class="owl-stage-outer owl-height" style="height: 412px;"><div class="owl-stage" style="transform: translate3d(-1310px, 0px, 0px); transition: all; width: 5240px;">
            <div class="owl-item cloned" style="width: 625px; margin-right: 30px;"><div class="card card--big">
        ...
        <div class="owl-item active" style="width: 625px; margin-right: 30px;"><div class="card card--big">
                <a href="https://gogame.volkovdesign.com/details.html" class="card__cover">
            ...
            </div></div><div class="owl-item active" style="width: 625px; margin-right: 30px;"><div class="card card--big">
                <a href="https://gogame.volkovdesign.com/details.html" class="card__cover">
            ...
            </div></div><div class="owl-item" style="width: 625px; margin-right: 30px;"><div class="card card--big">
                <a href="https://gogame.volkovdesign.com/details.html" class="card__cover">
                    <img src="{{asset('GoGame – Digital marketplace HTML Template Preview - ThemeForest_files/9.jpg')}}" alt="">
                </a>
            ...
            </div></div><div class="owl-item cloned" style="width: 625px; margin-right: 30px;"><div class="card card--big">
                <a href="https://gogame.volkovdesign.com/details.html" class="card__cover">
                    <img src="{{asset('GoGame – Digital marketplace HTML Template Preview - ThemeForest_files/4.jpg')}}" alt="">
                </a>
