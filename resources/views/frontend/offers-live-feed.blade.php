@if ($buyerRequest->status == 'cancelled')
    <div class="p-3 d-flex flex-column align-items-center">
        ...
        <div class="text-theme-light fw-bold">Boosting request is cancelled</div>
    </div>
@else
    @if (count($buyerRequest->requestOffers) !== 0)
        @foreach ($buyerRequest->requestOffers as $key => $offer)    
            <div class="row w-100 p-0 px-md-3 py-md-3 align-items-center dividor-border-theme-bottom">
                <div class="seller_details d-flex col-12 col-md-3 text-left dividor-m-border-bottom p-2 pt-3 p-md-0">
                    ...
                    <div class="d-flex flex-column">
                        <a wire:navigate href="{{ url('user-profile') }}/{{ $offer->user->username }}?tab=Offers&category=Currency">
                            <div id="sellerName" class="fs-15 fw-bold text-theme-primary">{{$offer->user->username}}</div>
                        </a>
                ...
                <div class="col-6 col-md-3 align-items-start align-items-md-end d-flex flex-column dividor-m-border-bottom p-2 p-md-0">
                ...
                <div class="col-6 col-md-3 align-items-end d-flex flex-column align-items-end dividor-m-border-bottom p-2 p-md-0">
                    <span class="d-none d-md-block fs-15 text-black-70">Price</span>
                    <strong class="f-15">${{$offer->price}}</strong>
                </div>
                <div class="col-12 col-md-3 d-flex justify-content-start align-items-center justify-content-md-end dividor-m-border-bottom mt-1 p-2 pb-3 p-md-0">
